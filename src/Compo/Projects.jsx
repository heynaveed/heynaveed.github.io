    ...
    return (
        ...
        <Flex  w={{base : '85%', md: '80%', lg : '80%'}} m='auto' columnGap='80px' rowGap='25px' mt={{base : '30px', lg :'20px'}} direction={{base : 'column-reverse', lg :'column-reverse'}}  p={{base : '15px', md :'20px', lg :'25px'}}>
            <Box m='auto'>
                ...
                <Text fontSize={{base : '12px', md : '14px' , lg :'16px'}} mt={{base : '5px', md :'10px', lg : '12px'}} >A collaborative project built by a team of 4 executed in 4 days</Text>
                ...
                <Flex gap='20px' mt={{base :'10px'}}> 
                    <Text  fontSize={{base :'20px', md : '25px', lg : '26px'}} ><a href="https://tripvillas.vercel.app/" target='_blank'><AiFillChrome/></a></Text>
                    <Text  fontSize={{base :'20px', md : '25px', lg : '26px'}} ><a href="https://github.com/akashkumar-404/kindly-earthquake-283" target='_blank'><AiFillGithub/></a></Text>
                </Flex>
            </Box>
        ...
        <Flex  w={{base : '85%', md: '80%', lg : '80%'}} m='auto' columnGap='80px' rowGap='25px' mt={{base : '30px', lg :'40px'}} direction={{base : 'column-reverse', lg :'column-reverse'}}  p={{base : '15px', md :'20px', lg :'25px'}}>
            <Box>
                ...
                <Text fontSize={{base : '12px', md : '14px' , lg :'16px'}} mt={{base : '5px', md :'10px', lg : '12px'}} >A collaborative project built by a team of 7 executed in 4 days</Text>
                <Text fontSize={{base : '14px', md : '18px', lg : '22px'}} mt={{base : '5px', md :'10px', lg : '12px'}} fontWeight='600'>Tech Stack</Text>
                <Text fontSize={{base : '10px', md : '14px'}} mt={{base : '5px', md :'5px', lg : '2px'}} letterSpacing={{base : '0px', lg :'2px'}}>HTML | CSS | JAVASCRIPT</Text>
                <Flex gap='20px' mt={{base :'10px'}}> 
                    <Text  fontSize={{base :'20px', md : '25px', lg : '26px'}} ><a href="https://celebrated-stardust-10d06f.netlify.app/" target='_blank'><AiFillChrome/></a></Text>
                    <Text  fontSize={{base :'20px', md : '25px', lg : '26px'}} ><a href="https://github.com/Sumit-Gangwar/Farfetch-Project" target='_blank'><AiFillGithub/></a></Text>
                </Flex>
            </Box>
         ...
         <Flex  w={{base : '85%', md: '80%', lg : '80%'}} m='auto' columnGap='80px' rowGap='25px' mt={{base : '30px', lg :'40px'}} direction={{base : 'column-reverse', lg :'column-reverse'}}  p={{base : '15px', md :'20px', lg :'25px'}}>
            <Box m='auto'>
                ...
                <Text fontSize={{base : '12px', md : '14px' , lg :'16px'}} mt={{base : '5px', md :'10px', lg : '12px'}} >A collaborative project built by a team of 6 executed in 4 days</Text>
                <Text fontSize={{base : '14px', md : '18px', lg : '22px'}} mt={{base : '5px', md :'10px', lg : '12px'}} fontWeight='600'>Tech Stack</Text>
                <Text fontSize={{base : '10px', md : '14px'}} mt={{base : '5px', md :'5px', lg : '2px'}} letterSpacing={{base : '0px', lg :'2px'}}>HTML | CSS | JAVASCRIPT</Text>
                <Flex gap='20px' mt={{base :'10px'}}> 
                    <Text  fontSize={{base :'20px', md : '25px', lg : '26px'}} ><a href="https://famous-kitten-13c790.netlify.app/" target='_blank'><AiFillChrome/></a></Text>
                    <Text  fontSize={{base :'20px', md : '25px', lg : '26px'}} ><a href="https://github.com/AnshGirdhar1/Unit-2-Project" target='_blank'><AiFillGithub/></a></Text>
                </Flex>
            </Box>
